...
public class ChessboardTest {
    ...
    public void fullboard_Kings_isInCorrectSpot() {
        final Chessboard chessboard = Chessboard.fullBoard();
        Assertions.assertEquals("K", chessboard.getPiece(new Coordinates(3, 0)).getSymbol());
        Assertions.assertEquals("K", chessboard.getPiece(new Coordinates(3, 7)).getSymbol());
    }

    @Test
    public void fullboard_Queens_isInCorrectSpot() {
        final Chessboard chessboard = Chessboard.fullBoard();
        Assertions.assertEquals("Q", chessboard.getPiece(new Coordinates(4, 0)).getSymbol());
        Assertions.assertEquals("Q", chessboard.getPiece(new Coordinates(4, 7)).getSymbol());
    }
}
